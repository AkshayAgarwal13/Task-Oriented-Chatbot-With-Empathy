...
'train_model_file' : 'finetuned_ed/model', # Path where the trained model is saved
'predict_dataset' : 'customer_care', # Dataset used for predicting (test.txt)
'predict_model_file' : 'finetuned_ed/model' # Path of the model which will be used for prediction
}
finetuned_cc = {
'baseline_model' : 'transformer/generator', # Baseline model architecture used
'init_model' : 'zoo:tutorial_transformer_generator/model', # The initial model to use for fine-tuning
'fine_tune_dataset' : 'customer_care', # Dataset used for fine tuning (train.txt and valid.txt)
'train_model_file' : 'finetuned_cc/model', # Path where the trained model is saved
'predict_dataset' : 'customer_care', # Dataset used for predicting (test.txt)
'predict_model_file' : 'finetuned_cc/model' # Path of the model which will be used for prediction
}
finetuned_ed_cc = {
'baseline_model' : 'transformer/generator', # Baseline model architecture used
'init_model' : 'finetuned_ed/model', # The initial model to use for fine-tuning
'fine_tune_dataset' : 'customer_care', # Dataset used for fine tuning (train.txt and valid.txt)
'train_model_file' : 'finetuned_ed_cc/model', # Path where the trained model is saved
'predict_dataset' : 'customer_care', # Dataset used for predicting (test.txt)
'predict_model_file' : 'finetuned_ed_cc/model' # Path of the model which will be used for prediction
}
...
def train_main(model_dict):
    ...
    max_train_time=2*60, validation_every_n_epochs=0.01,
